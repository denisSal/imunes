...
proc drawNode { node_id } {
	...
	set obj [.panwin.f1.c create image $x $y -image [set $type] -tags "node $node_id selectable"]
    } else {
	global icon_size
	...
	switch $icon_size {
		...
		set obj [.panwin.f1.c create image $x $y -image img_$custom_icon -tags "node $node_id selectable"]
	    }
	    small {
		set icon_data [getImageData $custom_icon]
		image create photo img_$custom_icon -data $icon_data
		set img_$custom_icon [image% img_$custom_icon 70 $custom_icon]
		set obj [.panwin.f1.c create image $x $y -image [set img_$custom_icon] -tags "node $node_id selectable"]
	    }
	}
    }
    .panwin.f1.c addtag "t$obj" withtag $obj
